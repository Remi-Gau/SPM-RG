...
% interested in the "Pythagorean Displacement and Motion Regressors" toolbox,
...
XP_Folder = fullfile(StartFolder, 'Subjects_Data');
...
for SubjInd = 1:size(SubjectList,1)
    ...
    SubjFolder = fullfile(XP_Folder, ['Subject_' SubjID]);
    NiftiSourceFolder = fullfile(SubjFolder, 'Nifti', 'NoMoCo');
    ...
    for IndRun=1:NbRuns
        ...
        %%
        h=figure('name', ['Realignment: Subject ' SubjID ' ; Run ' num2str(IndRun)], ...
            'Position', [0, 0, 1200, 800], 'Visible', 'on', 'Color',[1 1 1])
